Pod::Spec.new do |s|
  ...
  s.source              = { :path => '.' }
  s.source_files        = 'ffmpeg_kit_flutter/Classes/**/*'
  s.public_header_files = 'ffmpeg_kit_flutter/Classes/**/*.h'
 ...
 # FFmpegKit has been officially retired.Place iOS dependent libraries locally to solve compilation problems
  ...
  s.subspec 'ffmpeg_kit_ios_local' do |ss|
    ss.vendored_frameworks = 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/ffmpegkit.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libavdevice.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libavcodec.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libavfilter.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libavformat.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libavutil.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libswresample.xcframework', 'ffmpeg_kit_flutter/Frameworks/ffmpeg-kit-ios-https/libswscale.xcframework'
  ...
  s.subspec 'min' do |ss|
    ss.source_files         = 'ffmpeg_kit_flutter/Classes/**/*'
    ss.public_header_files  = 'ffmpeg_kit_flutter/Classes/**/*.h'
